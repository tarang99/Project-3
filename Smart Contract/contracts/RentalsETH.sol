...
contract RentalTest {
    ...
    */
    function withdraw(uint amount, address payable recipient) public {
        ...
        */
        require(recipient == accountOne || recipient == accountTwo || recipient == accountThree || recipient == accountFour, "You don't own this account!");
    ...
    */
    function setAccounts(address payable RentAcc1, address payable RentAcc2, address payable RentAcc3, address payable RentAcc4) public{

        // Set the values of `accountOne` and `accountTwo` to `account1` and `account2` respectively.
        accountOne = RentAcc1;
        accountTwo = RentAcc2;
        accountThree = RentAcc3;
        accountFour = RentAcc4;
    }
